...
if __name__ == "__main__":
    ...
    word_embedding = pickle.load(open('/Users/chaitradaddolu/Desktop/nlp/assignment2/Data_Embedding/word_embedding.pkl', 'rb'))

    stopping_condition = False
    epoch = 0

    last_train_accuracy = 0
    best_validation_accuracy = 0  # Initialize best validation accuracy
    ...
    while not stopping_condition:
        ...
        if validation_accuracy > best_validation_accuracy:
            best_validation_accuracy = validation_accuracy  # Update best validation accuracy
    ...
    plt.plot(currepochs, losstrain, label='Training Loss')
    plt.title('Training Loss and Validation Accuracy')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.show()
    # plt.plot(currepochs, accuracy, label='Validation Accuracy')
    plt.plot(currepochs, accvalid, label='Validation Accuracy')
    plt.title('Training loss and validation accuracy')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.legend()
    ...
    print("Validation Accuracy: {}".format(best_validation_accuracy ))
